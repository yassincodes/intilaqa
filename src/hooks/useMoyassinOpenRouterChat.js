...
import { buildMoyassinChatSystemPrompt } from "../data/moyassinRoute";
import {
...
/**
 * محادثة OpenRouter لشخصيات مسار مياثن فقط (منطق مطابق لـ useCharacterOpenRouterChat).
 * @param {{ slug: string; name: string; welcomeChatAr: string }} character
 */
export function useMoyassinOpenRouterChat(character) {
  const systemPrompt = useMemo(
    () => buildMoyassinChatSystemPrompt(character),
    [character.slug],
  );
